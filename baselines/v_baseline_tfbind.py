"""Single-file implementation for Policy Gradient with baseline in TFBind-8 environment.

Run the script with the following command:
```bash
python baselines/v_baseline_tfbind.py
```
...
@hydra.main(config_path="configs/", config_name="v_baseline_tfbind", version_base=None)
