"""Single-file implementation for Reward-to-Go Policy Gradient in TFBind-8 environment.

Run the script with the following command:
```bash
python baselines/RTG_pg_tfbind.py
```
...
@hydra.main(config_path="configs/", config_name="RTG_pg_tfbind", version_base=None)
