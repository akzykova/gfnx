"""Single-file implementation for  Reward-to-Go Policy Gradient in QM9Small environment.

Run the script with the following command:
```bash
python baselines/RTG_pg_qm9_small.py
```
...
@hydra.main(config_path="configs/", config_name="RTG_pg_qm9_small", version_base=None)
