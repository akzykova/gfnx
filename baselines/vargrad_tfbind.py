"""Single-file implementation for Vargrad in TFBind-8 environment.

Run the script with the following command:
```bash
python baselines/vargrad_tfbind.py
```
...
@hydra.main(config_path="configs/", config_name="vargrad_tfbind", version_base=None)
