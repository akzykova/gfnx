...
def train_step(idx: int, train_state: TrainState) -> TrainState:
    ...
    def extract_advantage_components(
        ...
        entropy = current_traj_data.info["entropy"]
        entropy = jnp.where(current_traj_data.pad, 0.0, entropy) 
    ...
    def policy_loss_fn(
        ...
        forward_entropy = comp['forward_entropy']
        ...
        deltas = gflow_logreward + backward_logprobs + stop_gradient(forward_entropy) + V_next - V_current
    ...
    def update_baseline(
        ...
        for i in range(num_splits):
            ...
            deltas_reward = chunk['gflow_logreward'] + chunk['backward_logprobs'] + stop_gradient(chunk['forward_entropy'])
