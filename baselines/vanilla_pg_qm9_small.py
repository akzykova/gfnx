"""Single-file implementation for Vanilla Policy Gradient in QM9Small environment.

Run the script with the following command:
```bash
python baselines/vanilla_pg_qm9_small.py
```
...
@hydra.main(config_path="configs/", config_name="vanilla_pg_qm9_small", version_base=None)
def run_experiment(cfg: OmegaConf) -> None:
    ...
    if cfg.logging.use_writer:
        ...
        writer.init(
            ...
            tags=["Vanilla_PG", env.name.upper()],
